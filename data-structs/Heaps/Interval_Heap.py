# A heap with two values in each node, where left values are in a min heap and right values are in a max heap
# Stored here with indices 0-1 being a node, 2-3 being a node, etc.
# Essentially a double-ended heap!
